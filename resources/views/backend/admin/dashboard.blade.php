                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('Backend/asset/app-assets/images/icons/toolbox.svg') }}" alt="Toolbar svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('Backend/asset/app-assets/images/icons/parachute.svg') }}" alt="Parachute svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('Backend/asset/app-assets/images/icons/brush.svg') }}" alt="Brush svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('Backend/asset/app-assets/images/icons/star.svg') }}" alt="Star svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('Backend/asset/app-assets/images/icons/book.svg') }}" alt="Book svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('Backend/asset/app-assets/images/icons/rocket.svg') }}" alt="Rocket svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('Backend/asset/app-assets/images/icons/speaker.svg') }}" alt="Speaker svg" />
                                                            </div>
                                                        </div>
                                                        <div>
